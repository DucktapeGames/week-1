...
public class Basic_Tap_Logic : MonoBehaviour {
	...
	void Awake(){
		...
		song1[4,0] = false; song1[4,1] = false; song1[4,2] = false; //5
		...
		song1[20,0] = false; song1[20,1] = false; song1[20,2] = false; //1
		...
		song1[25,0] = false; song1[25,1] = false; song1[25,2] = true; //6
		...
		song1[29,0] = true; song1[29,1] = false; song1[29,2] = false; //10
		...
		song1[33,0] = false; song1[33,1] = false; song1[33,2] = true; //4
		...
		song1[37,0] = true; song1[37,1] = false; song1[37,2] = false; //8
		...
		song1[41,0] = false; song1[41,1] = false; song1[41,2] = true; //2
		...
		song1[45,0] = true; song1[45,1] = false; song1[45,2] = false; //6
		...
		song1[49,0] = false; song1[49,1] = false; song1[49,2] = true; //10
		...
		song1[53,0] = true; song1[53,1] = false; song1[53,2] = false; //4
		...
		song1[57,0] = false; song1[57,1] = false; song1[57,2] = true; //8
		song1[58,0] = false; song1[58,1] = false; song1[58,2] = true; //9
		song1[59,0] = false; song1[59,1] = true; song1[59,2] = false; //10
		song1[60,0] = false; song1[60,1] = false; song1[60,2] = false; //1
		song1[61,0] = true; song1[61,1] = false; song1[61,2] = false; //2
		song1[62,0] = false; song1[62,1] = true; song1[62,2] = false; //3
		song1[63,0] = false; song1[63,1] = false; song1[63,2] = true; //4
		song1[64,0] = false; song1[64,1] = true; song1[64,2] = false; //5
		song1[65,0] = true; song1[65,1] = false; song1[65,2] = false; //6
		...
		song1[70,0] = false; song1[70,1] = false; song1[70,2] = true; //1
		song1[71,0] = false; song1[71,1] = false; song1[71,2] = true; //2
		...
		song1[80,0] = false; song1[80,1] = false; song1[80,2] = false; //1
		...
		song1[91,0] = false; song1[91,1] = false; song1[91,2] = false; //2
		song1[92,0] = false; song1[92,1] = false; song1[92,2] = true; //3
		song1[93,0] = false; song1[93,1] = true; song1[93,2] = false; //4
		song1[94,0] = true; song1[94,1] = false; song1[94,2] = false; //5
		song1[95,0] = false; song1[95,1] = true; song1[95,2] = false; //6
		song1[96,0] = false; song1[96,1] = false; song1[96,2] = true; //7
		song1[97,0] = false; song1[97,1] = true; song1[97,2] = false; //8
		song1[98,0] = true; song1[98,1] = false; song1[98,2] = false; //9
		song1[99,0] = true; song1[99,1] = false; song1[99,2] = false; //10
		song1[100,0] = false; song1[100,1] = false; song1[100,2] = false; //1
		song1[101,0] = true; song1[101,1] = true; song1[101,2] = true; //2
		song1[102,0] = false; song1[102,1] = false; song1[102,2] = false; //3
		song1[103,0] = true; song1[103,1] = false; song1[103,2] = true; //4
		song1[104,0] = false; song1[104,1] = false; song1[104,2] = false; //5
		song1[105,0] = false; song1[105,1] = true; song1[105,2] = true; //6
		song1[106,0] = false; song1[106,1] = false; song1[106,2] = false; //7
		song1[107,0] = true; song1[107,1] = true; song1[107,2] = false; //8
		song1[108,0] = false; song1[108,1] = false; song1[108,2] = false; //9
		song1[109,0] = false; song1[109,1] = true; song1[109,2] = false; //10
